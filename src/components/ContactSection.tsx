...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitError('Could not send your message. Please try again or email janeica0531@outlook.com directly.');
    } finally {
              ...
              <Form onSubmit={handleSubmit} noValidate>
                ...
                {submitted && submitMode === 'mailto' && (
                  <Alert variant="info" className="mb-3" style={{ background: 'rgba(232, 196, 184, 0.1)', borderColor: 'rgba(232, 196, 184, 0.3)', color: 'var(--text-primary)' }}>
                    Your email app should open with the message ready to send. If it did not open, email janeica0531@outlook.com directly.
                  </Alert>
                )}
            ...
            >
              <div className="glass-card mb-4">
                ...
                <div className="mb-3">
                  ...
                  <a
                    href="mailto:janeica0531@outlook.com"
                    style={{
